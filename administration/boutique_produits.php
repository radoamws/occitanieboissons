...
<head>
  ...
  <title><?php echo $sitename; ?> | Création d'un produit</title>
    ...
    <div class="container-fluid" id="pcont">
      <div class="page-head">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Création d'un produit</li>
        </ol>
      </div>
      <div class="cl-mcont">    
          ...
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              <div id="boutique_produits" class="wizard wizard-ux">
                <ul class="steps">
                  <li data-target="#step1" class="active">Création<span class="chevron"></span></li>
              ...
              <div class="step-content">
                <form id="boutique" class="form-horizontal group-border-dashed boutique" name="publier"> 
                  <div class="step-pane active" id="step1">
                    <div class="form-group no-padding">
                      <div class="col-sm-12">
                        <h3 class="hthin">Création d'un produit</h3>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="categorie" class="categorie" type="hidden">
                      </div>
                    </div>
                    <div class="form-group">
