          ...
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              ...
              <div class="step-content">
                <form id="actualites" class="form-horizontal group-border-dashed actualites" name="publier"> 
                  <div class="step-pane active" id="step1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea style="height: 250px;" id="contenu" name="contenu" class="form-control"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
