    ...
    <div class="container-fluid" id="pcont">
      <div class="page-head">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo $admurl; ?>/brasseries.php">Brasseries</a></li>
        ...
        <div class="row wizard-row">
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              <div id="brasseries_redac" class="wizard wizard-ux">
                <ul class="steps">
              ...
              <div class="step-content">
                <form id="brasseries" class="form-horizontal group-border-dashed" name="publier"> 
                  <div class="step-pane active" id="step1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="country" class="pays_b" type="hidden">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea id="contenu" name="contenu" style="height: 250px;" class="form-control"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Ancre URL</label>
                      <div class="col-sm-9">
                        <input name="ancre" type="text" class="form-control" placeholder="Ancre URL">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Meta titre</label>
                      <div class="col-sm-9">
                        <input name="meta_title" type="text" class="form-control" placeholder="Ancre URL">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Meta description</label>
                      <div class="col-sm-9">
                        <textarea name="meta_description" style="height: 250px;" class="form-control"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Afficher Catalogue</label>
                      <div class="col-sm-9">
                        <div class="radio"> 
                          <label> <input type="checkbox" name="catalogue_active" class="icheck"></label> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Fabriquant ID</label>
                      <div class="col-sm-9">
                        <input name="id_fabriquant" type="text" class="form-control" placeholder="Fabriquant ID">
                      </div>
                    </div> 
                    <div class="form-group">
                      <div class="col-sm-12"> 
                        <button data-wizard="#brasseries_redac" class="btn btn-primary wizard-next">Étape suivante <i class="fa fa-caret-right"></i></button>
                      </div>
                    </div>									
                  </div>
                  <div class="step-pane" id="step2">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Texte alternatif (Image)</label>
                      <div class="col-sm-9">
                        <input name="image_alt" type="text" class="form-control" placeholder="Texte alternatif (Image)">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input class="btn btn-primary" type="file" name="logo">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="logo_preview" class="col-sm-9">
                        <div class="thumbnail hidden">
                          <img style="display: inline-table;height: 200px;" />
                          <div style="display: inline-table;" class="caption">
                            <h4></h4>
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Texte alternatif (Logo)</label>
                      <div class="col-sm-9">
                        <input name="logo_alt" type="text" class="form-control" placeholder="Texte alternatif (Logo)">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-12">
                        <button data-wizard="#brasseries_redac" class="btn btn-default wizard-previous"><i class="fa fa-caret-left"></i> Retour</button>
