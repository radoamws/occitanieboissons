<?php
  ...
  if(isset($_GET['modif'])) {
    if(!intval($_GET['modif'])) {
      ...
      $produits = $bdd->prepare("SELECT * FROM ob_boutique_produit WHERE id = :id");
      $produits->bindParam(":id", $_GET['modif']);
      $produits->execute();
      if($produits->rowCount() < 1) {
        header("Location: ".$admurl."/boutique.php");
        exit();
      } else {
        $p = $produits->fetch(PDO::FETCH_OBJ); 
      }
    }
  } else {
    header("Location: ".$admurl."/boutique.php");  
...
<html lang="fr">
  <head>
    ...
    <title><?php echo $sitename; ?> | Modification d'un produit</title>
        ...
        <div class="row wizard-row">
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              <div id="boutique_produits" class="wizard wizard-ux">
                <ul class="steps">
              ...
              <div class="step-content">
                <form id="boutique" class="form-horizontal group-border-dashed boutique" name="modifier"> 
                  <div class="step-pane active" id="step1">
                    <div class="form-group no-padding">
                      <div class="col-sm-12">
                        <h3 class="hthin">Modification d'un produit</h3>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Nom</label>
                      <div class="col-sm-9">
                        <input name="nom" type="text" class="form-control" placeholder="Nom" value="<?php echo $p->nom; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Description (facultatif)</label>
                      <div class="col-sm-9">
                        <input name="descr" type="text" class="form-control" placeholder="Description" value="<?php echo $p->description; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Catégorie</label>
                      <div class="col-sm-9">
                        <input name="categorie" class="categorie" type="hidden" value="<?php echo $p->categorie; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-sm-12"> 
                        <button data-wizard="#boutique_produits" class="btn btn-primary wizard-next">Étape suivante <i class="fa fa-caret-right"></i></button>
                      </div>
                    </div>                  
                  </div>
                  <div class="step-pane" id="step2">
                    <div class="form-group no-padding">
                      <div class="col-sm-12">
                        <h3 class="hthin">Images (560X440)</h3>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Image principale</label>
                      <div class="col-sm-9">
                        <input class="btn btn-primary" type="file" name="image" id="image" accept="image/*">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="image_preview" class="col-sm-9">
                        <div class="thumbnail">
                          <img style="display: inline-table;height: 200px;" src="<?php echo $p->image; ?>"/>
                          <div style="display: inline-table;" class="caption">
                            <h4><?php echo $p->image_short; ?></h4>
                            <p>Image actuelle</p>
                    ...
                    <div class="form-group">
                      <div class="col-sm-12">
                        <button data-wizard="#boutique_produits" class="btn btn-default wizard-previous"><i class="fa fa-caret-left"></i> Retour</button>
