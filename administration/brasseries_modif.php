<?php
  ...
  if(isset($_GET['modif'])) {
    if(!intval($_GET['modif'])) {
      header("Location: ".$admurl."/brasseries.php");
      exit();
    } else {
      $brasseries = $bdd->prepare("SELECT * FROM ob_brasseries WHERE id = :id");
      $brasseries->bindParam(":id", $_GET['modif']);
      $brasseries->execute();
...
<html lang="fr">
  ...
  <body>
    ...
    <div class="container-fluid" id="pcont">
      <div class="page-head">
        <h2>Modification d'une brasserie</h2>
        <ol class="breadcrumb">
          <li><a href="<?php echo $admurl; ?>">Acceuil</a></li>
          <li><a href="<?php echo $admurl; ?>/brasseries.php">Brasserie</a></li>
          ...
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              ...
              <div class="step-content">
                <form id="brasseries" class="form-horizontal group-border-dashed" name="modifier"> 
                  <div class="step-pane active" id="step1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="nom" type="text" class="form-control" placeholder="Nom" value="<?php echo $b->name; ?>">
                      </div>
                    </div>  
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Pays</label>
                      <div class="col-sm-9">
                        <input name="pays" class="pays_b" type="hidden" value="<?php echo $b->country; ?>">
                      </div>
                    </div> 
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Contenu</label>
                      <div class="col-sm-9">
                        <textarea style="height: 250px;" name="contenu" id="contenu" class="form-control"><?php echo $b->content; ?></textarea>
                      </div>
                    </div>
                    <!--<div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <div class="radio"> 
                          <label> <input type="checkbox" name="hide" class="icheck" <?php if($b->hiden == "1"){echo "checked";} ?>></label> 
                        </div>
                      </div>
                    </div>-->
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <div class="radio"> 
                          <label> <input type="checkbox" name="catalogue_active" class="icheck" <?php if($b->hiden == "1"){echo "checked";} ?>></label> 
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="id_fabriquant" type="text" class="form-control" placeholder="Fabriquant ID" value="<?php echo $b->id_fabriquant; ?>">
                      </div>
                    </div>  
                    <div class="form-group">
                      <div class="col-sm-12"> 
                  ...
                  <div class="step-pane" id="step2">
                    ...
                    <div class="form-group">
                      <div class="image_preview" class="col-sm-9">
                        <div class="thumbnail">
                          <img style="display: inline-table;height: 200px;" src="<?php echo $b->image_url; ?>" />
                          <div style="display: inline-table;" class="caption">
                            <h4><?php echo $b->image_short; ?></h4>
                            <p>Image actuelle</p>
                    ...
                    <div class="form-group">
                      <div class="logo_preview" class="col-sm-9">
                        <div class="thumbnail">
                          <img style="display: inline-table;height: 200px;" src="<?php echo $b->logo_url; ?>"/>
                          <div style="display: inline-table;" class="caption">
                            <h4><?php echo $b->logo_short; ?></h4>
                            <p>Logo actuel</p>
                            <button type="button" class="btn btn-default"><i class="fa fa-times"></i>Supprimer</button>
                          </div>
                          <div style="clear: both;"></div>
                    ...
                    <div class="form-group">
                      <div class="col-sm-12">
                        ...
                        <input name="id" type="hidden" value="<?php echo $b->id; ?>">
                      </div>
                    </div>  
                  </div>
                </form>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        var textarea_content = $('textarea#contenu').summernote('code');
      });
    </script>
