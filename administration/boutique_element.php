...
<head>
  ...
  <title><?php echo $sitename; ?> | Création d'un élément</title>
    ...
    <div class="container-fluid" id="pcont">
      <div class="page-head">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Création d'un élément</li>
        </ol>
      </div>
      <div class="cl-mcont">    
          ...
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              ...
              <div class="step-content">
                <form id="boutique_element" class="form-horizontal group-border-dashed boutique" name="publier"> 
                  <div class="step-pane active" id="step1">
                    <div class="form-group no-padding">
                      <div class="col-sm-12">
                        <h3 class="hthin">Création d'un élément</h3>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="contenance" type="text" class="form-control" placeholder="Contenance">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Alcool (°)</label>
                      <div class="col-sm-9">
                        <input name="alcool" type="text" class="form-control" placeholder="Alcool">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="prix" type="text" class="form-control" placeholder="Prix HT">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">TVA</label>
                      <div class="col-sm-9">
                        <input name="tva" type="text" data-mask="tva" class="form-control" placeholder="__,__%">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Brasserie (facultatif)</label>
                      <div class="col-sm-9">
                        <input name="brasserie" class="brasseriesid" type="hidden">
                      </div>
                    </div>
                    <div class="form-group">
