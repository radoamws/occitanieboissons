          ...
          <div class="col-md-12 fuelux">
            <div class="block-wizard">
              ...
              <div class="step-content">
                <form id="actualites" class="form-horizontal group-border-dashed actualites" name="modifier"> 
                  <div class="step-pane active" id="step1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input name="descr" type="text" class="form-control" placeholder="Description" value="<?php echo $a->descr; ?>">
                      </div>
                    </div>
                    <div class="form-group">
